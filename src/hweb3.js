...
class Hweb3 {
  /**
   * Hweb3 constructor.
   * @param {string|Hweb3Provider} provider Either URL string to create HttpProvider or a Hweb3 compatible provider.
   */
   ...
   * @param {string} urlString URL of the blockchain API. eg. http://htmlcoin:htmlcoin@127.0.0.1:14889
   ...
   * @param {number} blocks How many blocks are generated immediately.
   * @param {string} address The address to send the newly generated htmlcoin to.
   * @param {number} maxTries How many iterations to try (default = 1000000).
   * @return {array} Hashes of blocks generated.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Htmlcoin address.
   * @param {string} address Htmlcoin address
  ...
  /**
   * Converts a hex address to Htmlcoin address.
   * @param {string} hexAddress Htmlcoin address in hex format.
   * @return {Promise} Htmlcoin address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Htmlcoin address.
   * @param {string} address Htmlcoin address to validate.
   ...
   * @param {string} address The Htmlcoin address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the Htmlcoin server.
  ...
  /**
   * Gets the account name associated with the Htmlcoin address.
   * @param {string} address The Htmlcoin address for account lookup.
  ...
  /**
   * Gets the Htmlcoin address based on the account name.
  ...
  /**
   * Gets the Htmlcoin address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Htmlcoin address array or Error.
   */
  ...
  /**
   * Gets a new Htmlcoin address for receiving payments.
   ...
   * @return {Promise} Array of addresses with Htmlcoin balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send Htmlcoin to.
   * @param {number} amount Amount of Htmlcoin to send.
   ...
   * @param {string} senderAddress The Htmlcoin address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in HTMLCOIN/kB.
